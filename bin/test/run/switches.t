...

{
    ...
    my $v = sprintf "%vd", $^V;
    like( runperl( switches => ['-v'] ),
	  qr/This is specperl, v$v built for $Config{archname}.+with \d+ registered patches, see specperl -V for more detail.+Copyright.+Larry Wall.+Artistic License.+GNU General Public License/s,
          '-v looks okay' );
