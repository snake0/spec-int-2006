...
print 'not ' unless ($a eq "#!s\0\0cpe");
print "ok 10\n";
...
print "ok 32\n";
# this we should have
print 'not ' unless ($b eq '#!cpcpeabc');
print "ok 33\n";
...
print "ok 34\n";
sysread(I, $b, 3);
print 'not ' unless $b eq 'cpc';
print "ok 35\n";

print 'not ' unless sysseek(I, -2, 1) == 3;
print "ok 36\n";
sysread(I, $b, 4);
print 'not ' unless $b eq 'pcpe';
print "ok 37\n";
