...
"x86_64-linux-2.6.32-042stab076.8" or
	die "Errno architecture (x86_64-linux-2.6.32-042stab076.8) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
