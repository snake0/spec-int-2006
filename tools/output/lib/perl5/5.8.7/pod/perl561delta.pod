...
Overall, PerlBenchmark results exhibit lower average error and better timing
accuracy.  
...
changed.  For example:
   ...
   use PerlBenchmark;$x=3;timethese(-5,{a=>sub{$x*$x},b=>sub{$x**2}})
...
For other details, see L<PerlBenchmark>.
