...
XS(XS_threads_new); /* prototype to pass -Wmissing-prototypes */
XS(XS_threads_new)
{
    dXSARGS;
    if (items < 2)
	Perl_croak(aTHX_ "Usage: threads::new(classname, function_to_call, ...)");
    {
	char *	classname = (char *)SvPV_nolen(ST(0));
	SV *	function_to_call = ST(1);
#line 679 "threads.xs"
{
    AV* params = newAV();
    if (items > 2) {
...
XS(XS_threads_list)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: threads::list(classname)");
    SP -= items;
    {
	char *	classname = (char *)SvPV_nolen(ST(0));
#line 694 "threads.xs"
...
XS(XS_threads_self)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: threads::self(classname)");
    {
	char *	classname = (char *)SvPV_nolen(ST(0));
#line 716 "threads.xs"
{
...
XS(XS_threads_tid)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: threads::tid(thread)");
    {
	int	RETVAL;
	dXSTARG;
	ithread *	thread = SV_to_ithread(aTHX_ ST(0));

	RETVAL = ithread_tid(thread);
...
XS(XS_threads_join)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: threads::join(obj)");
    SP -= items;
    {
	SV *	obj = ST(0);
#line 727 "threads.xs"
...
XS(XS_threads_detach)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: threads::detach(thread)");
    {
	ithread *	thread = SV_to_ithread(aTHX_ ST(0));

	ithread_detach(thread);
    }
    XSRETURN_EMPTY;
}
...
XS(XS_threads_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: threads::DESTROY(thread)");
    {
	SV *	thread = ST(0);

	ithread_DESTROY(thread);
    }
    XSRETURN_EMPTY;
}
...
#if XSubPPtmpAAAA
        newXS("threads::new", XS_threads_new, file);
