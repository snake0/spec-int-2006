/*
 ...
 /var/services/homes/spparmar/spec2006/tools/src/perl-5.8.7/miniperl ../bin/enc2xs -Q -O -o ebcdic_t.c -f ebcdic_t.fnm
*/
#include "encode.h"

static encpage_t utf8_cp1026[6];
static encpage_t utf8_cp1047[4];
static encpage_t utf8_cp37[4];
static encpage_t utf8_cp500[4];
static encpage_t utf8_cp875[6];
static encpage_t utf8_posix_bc[4];
...
static encpage_t cp1026_utf8[68] = {
...
static encpage_t cp1047_utf8[54] = {
...
static encpage_t cp500_utf8[52] = {
...
static encpage_t cp875_utf8[56] = {
...
static encpage_t utf8_cp875_c2[8] = {
...
static encpage_t utf8_cp875_ce[5] = {
...
static encpage_t posix_bc_utf8[57] = {
...
encode_t cp1026_encoding = 
 {cp1026_utf8,utf8_cp1026,(U8 *)"\x6F",1,1,1,{"cp1026",(const char *)0}};

encode_t cp1047_encoding = 
 {cp1047_utf8,utf8_cp1047,(U8 *)"\x6F",1,1,1,{"cp1047",(const char *)0}};

encode_t cp37_encoding = 
 {cp37_utf8,utf8_cp37,(U8 *)"\x6F",1,1,1,{"cp37",(const char *)0}};

encode_t cp500_encoding = 
 {cp500_utf8,utf8_cp500,(U8 *)"\x6F",1,1,1,{"cp500",(const char *)0}};

encode_t cp875_encoding = 
 {cp875_utf8,utf8_cp875,(U8 *)"\x6F",1,1,1,{"cp875",(const char *)0}};

encode_t posix_bc_encoding = 
 {posix_bc_utf8,utf8_posix_bc,(U8 *)"\x6F",1,1,1,{"posix-bc",(const char *)0}};
