...
if [ -n "$INSTALLDIR" ]; then
  ...
  privlib=$INSTALLDIR/lib/perl5
  privlibexp=$INSTALLDIR/lib/perl5
  sitearch=$INSTALLDIR/lib/perl5
  sitearchexp=$INSTALLDIR/lib/perl5
  sitelib=$INSTALLDIR/lib/perl5
  sitelibexp=$INSTALLDIR/lib/perl5
  installarchlib=$INSTALLDIR/lib/perl5
  installprivlib=$INSTALLDIR/lib/perl5
  installsitearch=$INSTALLDIR/lib/perl5
  installsitelib=$INSTALLDIR/lib/perl5
  vendorprefix=$INSTALLDIR usevendorprefix='define';
else
