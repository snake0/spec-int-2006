...
union record *findrec _P_((void));
void userec _P_((union record *rec));
union record *endofrecs _P_((void));
void anno _P_((FILE *stream, char *prefix, int savedp));

#ifdef HAVE_VPRINTF
void msg _P_((char *, ...));
void msg_perror _P_((char *, ...));
#else
void msg ();
void msg_perror ();
#endif
