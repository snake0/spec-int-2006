     ...
     char **argv;
{
  ...
  /* This used to happen at buffer.c line 67, but .NET 2005 doesn't like
   * that (non-constant initializer).
   */
  msg_file = stdout;
	...
	case '7':
	  {
	    ...
	    d = getoldopt (argc, argv, "lmh", NULL, NULL);
#ifdef MAYBEDEF
