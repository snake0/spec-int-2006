...
LDFLAGS='-L/var/services/homes/spparmar/spec2006/tools/output/lib  '
ALLOCA=''
LOADLIBES='-lrt  '
extras=''
# SPEC CPU -- there is no remote
REMOTE='stub'
GLOBLIB=''
...
# SPEC CPU -- remove errant $U; nobody has a non-ANSI compiler
objs=`echo $objs | sed 's/\$U//g'`
