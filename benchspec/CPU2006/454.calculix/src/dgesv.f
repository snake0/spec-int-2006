...
* SPEC CPU2006: computed goto is obsolete in f95; silence compiler
* warnings by switching to CASE jh/11/sep/2004
...
*
     ...
     $   RETURN
      ...
      C4 = C3( 2:3 )
*
*SPEC CPU2006 convert to CASE to silence f95 warnings  jh/11/sep/2004
