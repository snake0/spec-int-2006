...
!
      subroutine matdata_he(cocon,ncocon,imat,iorien,pgauss,orab,ntmat_,
...
!
     ...
     &  j1,j2,j3,j4,jj,ntmat_,id,two,seven,nrhcon(*),nshcon(*)
!
      real*8 cocon(0:6,ntmat_,*),orab(7,*),coconloc(6),t1l,
     &  skl(3,3),xa(3,3),pgauss(3),rhcon(0:1,ntmat_,*),
     &  shcon(0:1,ntmat_,*),rho,sph
!
