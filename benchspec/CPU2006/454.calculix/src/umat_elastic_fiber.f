...
!
     ...
     &       (amat,iel,iint,kode,elconloc,eloc,eth,
...
!
!
!     The present material law is for a anisotropic hyperelastic material
!     composed of stiff hyperelastic fibers woven in an isotropic neo-Hooke
!     type base material
!     The user defined constants are discussed in the User's Manual.
!     There are no internal state variables.
! 
      implicit none
!
      character*20 amat
