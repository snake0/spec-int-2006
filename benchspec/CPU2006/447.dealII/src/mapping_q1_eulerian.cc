...
//    $Id: mapping_q1_eulerian.cc,v 1.1 2004/09/14 00:51:24 wolf Exp $
//    Version: $Name:  $
//
//    Copyright (C) 2001, 2002, 2003, 2004 by the deal.II authors and Michael Stadler
//
  ...
  std::vector<Point<dim> > &a) const
{
  ...
  const unsigned int yan = shiftmap_dof_handler->get_fe().dofs_per_cell;
  Vector<double> mapping_values (yan);
