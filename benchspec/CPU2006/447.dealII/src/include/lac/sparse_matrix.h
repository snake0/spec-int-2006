//----------------------------  sparse_matrix.h  ---------------------------
//    $Id: sparse_matrix.h,v 1.4 2004/09/19 22:35:21 wolf Exp $
//    Version: $Name:  $
//
      ...
      private:
        ...
        class Reference 
        {
          public:
                                              ...
                                              * Constructor.
                                              */
            Reference (const internals::SparseMatrixIterators::Accessor<number,false> *accessor) 
	      :
	      accessor (accessor)
	      {}
		...
		return *this;
          ...
          private:
                                              ...
                                              * presently point to.
                                              */
            const internals::SparseMatrixIterators::Accessor<number,false> *accessor;
        };
