...
#if !defined(SPEC_CPU) && defined(_MSC_VER) && (_MSC_VER >= 1020)
# pragma once
#endif
...
#if !defined(SPEC_CPU) && defined(__BORLANDC__) && __BORLANDC__ == 0x551
...
#endif
    {
#if defined(SPEC_CPU) || !defined(BOOST_NO_EXCEPTIONS)
