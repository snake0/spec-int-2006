//----------------------------  data_out_base.h  ---------------------------
//    $Id: data_out_base.h,v 1.3 2006/01/23 23:53:16 wolf Exp $
//    Version: $Name:  $
//
...
class DataOutBase 
{
  public:
    ...
    struct Patch
    {
					  ...
					  */
	Point<spacedim> vertices[GeometryInfo<4>::vertices_per_cell];
					  ...
					  * sub-grid cells.
					  */
	unsigned int neighbors[GeometryInfo<4>::faces_per_cell];
