//-----------------------------------------------------------------------
//    $Id: table.h,v 1.5 2006/01/23 23:53:16 wolf Exp $
//    Version: $Name:  $
//
 ...
 */
    ...
    class Accessor<N,T,C,1>
    {
      ...
      public:
                                          ...
                                          * range check.
                                          */
        reference operator [] (const unsigned int i) const
	  {
...
#  ifndef DEAL_II_TEMPL_SPEC_FRIEND_BUG
					...
					// Declaration is standard compliant
					// but provide workaround for compilers
					// that prefer otherwise
#    ifndef SPEC_CPU_TABLE_WORKAROUND
