 ...
 *---------------------------------------------------------------------------
 * $File: //depot/povray/3.5/source/isosurf.cpp $
 * $Revision: #65 $
 * $Change: 3010 $
...
/* Disabled for SPEC as the cache code is unpredictable depending on compiler optimisations [trf]
	if(ISOSRF->cache)
	{
...
//	ISOSRF->cache = false; // Disabled, see comment near top of IsoSurface_Function_Find_Root [trf]
	EP1.t = *Depth1;
	...
	{
//		ISOSRF->cache = true; // Disabled, see comment near top of IsoSurface_Function_Find_Root [trf]
